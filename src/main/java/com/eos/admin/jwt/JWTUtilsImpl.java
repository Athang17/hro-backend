...
public class JWTUtilsImpl {
	 private SecretKey Key;
		...
		public String generateToken(VendorEntity user) {
	    	return Jwts.builder()
	    			.subject(user.getVendorName())
	    			.issuedAt(new Date(System.currentTimeMillis()))
	    			.expiration(new Date(System.currentTimeMillis() + EXPIRATION_TIME))
	    			.signWith(Key)
	    			.compact();
		...
		public String generateRefreshToken(HashMap<String, Object> claims, VendorEntity user) {
	    	return Jwts.builder()
	    			.claims(claims)
	    			.subject(user.getVendorName())
	    			.issuedAt(new Date(System.currentTimeMillis()))
